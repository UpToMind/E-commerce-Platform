...
import com.ecommerce.system.payment.service.dataaccess.outbox.entity.OrderOutboxEntity;
...
import com.ecommerce.system.payment.service.domain.ports.input.message.listener.PaymentRequestMessageListener;
...
public class PaymentRequestMessageListenerTest {
    ...
    private final static String USER_ID = "d215b5f8-0249-4dc5-89a3-51fd148cfb41";
    ...
    private PaymentRequest getPaymentRequest(String sagaId) {
        return PaymentRequest.builder()
                ...
                .paymentOrderStatus(com.ecommerce.system.domain.valueobject.PaymentOrderStatus.PENDING)
                .userId(USER_ID)
                .price(PRICE)
