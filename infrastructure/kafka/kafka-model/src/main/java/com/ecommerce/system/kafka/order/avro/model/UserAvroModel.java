...
public class UserAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6922875719506120590L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserAvroModel\",\"namespace\":\"com.ecommerce.system.kafka.order.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"username\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"firstName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public UserAvroModel(java.lang.String id, java.lang.String username, java.lang.String firstName, java.lang.String lastName) {
    this.id = id;
   ...
   */
  public static com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder newBuilder() {
    return new com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder();
  }
   ...
   * @return A new UserAvroModel RecordBuilder
   */
  public static com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder newBuilder(com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder other) {
    if (other == null) {
      return new com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder();
    } else {
      return new com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder(other);
    }
  }
   ...
   * @return A new UserAvroModel RecordBuilder
   */
  public static com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder newBuilder(com.ecommerce.system.kafka.order.avro.model.UserAvroModel other) {
    if (other == null) {
      return new com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder();
    } else {
      return new com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ecommerce.system.kafka.order.avro.model.UserAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder setUsername(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.system.kafka.order.avro.model.UserAvroModel.Builder clearLastName() {
      lastName = null;
